...
test_data=FashionMNIST(root='D:/Code/pytorch/LeNet/data',train=False,transform=transforms.Compose([transforms.Resize(227),transforms.ToTensor()]),download=True)
